...
const JobsCard = (props) => {
    ...
    const handleApply = () => {
        ...
        ApplyJob(props.item, UserDetails.uid)
    }
    ...
    return (
        ...
        <Grid item key={props.card} xs={12} sm={6} md={4}>
            ...
            >
                ...
                <CardActions>
                    <DialogBox ButtonText={"Apply"} size="small" DialogBoxTitle={"Do you want to apply?"} DialogBoxText={"Note:Before apply on any job make sure you have completely fill your profile"} AgreeButtonText={"Yes"} CancelButtonText={"No"}
                        handleAgreeClick={handleApply}
                    />
                    {/* <EditModal
